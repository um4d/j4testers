...
public class ContactDataGenerator {
    ...
    private void saveAsCsv(List<ContactData> contacts, File file) throws IOException {
        ...
        for (ContactData contact : contacts) {
            writer.write(String.format("%s;%s;%s\n",
                    contact.getName(), contact.getLastName(), contact.getGroup()));
        }
        writer.close();
    }
    ...
    private static String[] lastNames = {"Smith", "Murphy", "Smith", "Li", "Smith", "Smith", "Jones", "O'Kelly", "Johnson", "Smith", "Jones", "Wilson", "Williams", "O'Sullivan", "Williams", "Lam", "Williams", "Williams", "Brown", "Walsh", "Brown", "Martin", "Brown", "Brown", "Taylor", "Smith", "Jones", "Gelbero", "Wilson", "Taylor", "Davies", "O'Brien", "Miller", "Roy", "Taylor", "Jones", "Wilson", "Byrne", "Davis", "Tremblay", "Morton", "Singh", "Evans", "O'Ryan", "Garcia", "Lee", "White", "Wang", "Thomas", "O'Connor", "Rodriguez", "Gagnon", "Martin", "Anderson", "Roberts", "O'Neill", "Wilson", "Wilson", "Anderson", "Li"};
